...
class Report extends Component
{
    ...
    {
        $this->today = VP::whereDate('created_at', Carbon::today())->count(); 
        $this->finger_today = VP::whereDate('created_at', Carbon::today())->groupBy('fingerprint')->count();
        $this->finger_count = VP::groupBy('fingerprint')->count();
